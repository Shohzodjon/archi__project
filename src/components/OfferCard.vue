...
<template>
    <div class="offer__card p-6 md:max-w-[412px] max-h-[329px] relative rounded-[6px] lg:min-w-[240px]">
        <div class="absolute bg-blue-700 -top-[54px] left-6 p-[10px] rounded-sm" :class="$attrs.class"><span class="max-w-20 max-h-20" v-html="props.img_url"></span></div>
        <!-- end of card img -->
